  ...
  <body>
    ...
    <main>
         ...
         <div class="row ">
           <div class="col-lg-6 col-md-10 mx-auro text-center" style="margin:auto;margin-top:100px;">
             <a href="article.php?article=<?php echo $donnees['id'] ?>">
               <h2 style=""> <?php echo htmlspecialchars($donnees['titre']); ?> </h2>
               <h3 style=""> <?php echo htmlspecialchars($donnees['subtitre']); ?> </h3>
               <p style=""> <?php echo $donnees['date_creation_fr']; ?> </p>
             </a>
     ...
     $req->closeCursor();
        ...
        <a href="ajoute.php" class="btn btn-success">ajoute un article</a>
